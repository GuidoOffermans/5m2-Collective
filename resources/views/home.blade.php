...
@section('content')
    <section
        class="flex flex-col text-center place-content-center items-center lg:p-4 relative"

    >
        <div class="heart-container bg-no-repeat bg-contain fixed top-20 z-0 h-full w-full m-auto bg-center" style="background-image: url('/images/icons/big-heart-xl.jpg')"> </div>
            <div class="my-6"></div>

            <h1 class="font-Ogg font-bold text-6xl lg:text-[100px] leading-[1.09] z-10">
